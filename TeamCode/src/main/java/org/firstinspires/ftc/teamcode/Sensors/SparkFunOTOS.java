...
public class SparkFunOTOS extends I2cDeviceSynchDevice<I2cDeviceSynch> {
     ...
     */
    public void getVersionInfo(SparkFunOTOS.Version hwVersion, SparkFunOTOS.Version fwVersion) {
    ...
    public boolean selfTest() {
        ...
        SparkFunOTOS.SelfTestConfig selfTest = new SparkFunOTOS.SelfTestConfig();
        selfTest.set((byte) 1);
    ...
    public SparkFunOTOS.SignalProcessConfig getSignalProcessConfig() {
        ...
        return new SparkFunOTOS.SignalProcessConfig(deviceClient.read8(REG_SIGNAL_PROCESS));
    }
     ...
     */
    public void setSignalProcessConfig(SparkFunOTOS.SignalProcessConfig config) {
    ...
    public SparkFunOTOS.Status getStatus() {
        return new SparkFunOTOS.Status(deviceClient.read8(REG_STATUS));
    }
     ...
     */
    public void setOffset(SparkFunOTOS.Pose2D pose) {
     ...
     */
    public void getPosVelAcc(SparkFunOTOS.Pose2D pos, SparkFunOTOS.Pose2D vel, SparkFunOTOS.Pose2D acc) {
     ...
     */
    public void getPosVelAccStdDev(SparkFunOTOS.Pose2D pos, SparkFunOTOS.Pose2D vel, SparkFunOTOS.Pose2D acc) {
        // Read all pose registers
     ...
     */
    public void getPosVelAccAndStdDev(SparkFunOTOS.Pose2D pos, SparkFunOTOS.Pose2D vel, SparkFunOTOS.Pose2D acc,
                                      SparkFunOTOS.Pose2D posStdDev, SparkFunOTOS.Pose2D velStdDev, SparkFunOTOS.Pose2D accStdDev) {
        // Read all pose registers
    ...
    protected SparkFunOTOS.Pose2D readPoseRegs(byte reg, double rawToXY, double rawToH) {
    ...
    protected void writePoseRegs(byte reg, SparkFunOTOS.Pose2D pose, double xyToRaw, double hToRaw) {
    ...
    protected SparkFunOTOS.Pose2D regsToPose(byte[] rawData, double rawToXY, double rawToH) {
    ...
    protected void poseToRegs(byte[] rawData, SparkFunOTOS.Pose2D pose, double xyToRaw, double hToRaw) {
