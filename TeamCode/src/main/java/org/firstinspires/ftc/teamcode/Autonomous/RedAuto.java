...
//                .build();
        ...
        if (org.firstinspires.ftc.teamcode.Vision.redProcessor.returnPos() == 1){
            //currentVisionState = VisionState.LEFT;
            currentVisionState = VisionState.LEFT;
        } else if (org.firstinspires.ftc.teamcode.Vision.redProcessor.returnPos() == 2) {
            currentVisionState = VisionState.MIDDLE;
        } else if (org.firstinspires.ftc.teamcode.Vision.redProcessor.returnPos() == 3) {
